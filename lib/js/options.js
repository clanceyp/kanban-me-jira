	...
	options = {
		ops:{
			"input":[
				...
				,{"name":"RefreshTime","label":"Refresh time","type":"text","html5":"range",ops:{"min":5,"max":600,"step":5,"range-type":"s"}}
				...
				,{"name":"TicketPriorityColourMapping","label":"Ticket priority to background colour mapping","type":"text"}
			]
		},
		init:function(){
