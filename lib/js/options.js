	...
	options = {
		ops:{
			"input":[
				...
				,{"name":"PopupTemplate","label":"Mustache template","type":"textarea"}
				...
				,{"name":"KanbanTemplate","label":"Mustache template","type":"textarea"}
				...
				,{"name":"BackgroundImage","label":"Background image","type":"select",options:{"carbon_fibre":"carbon fibre","corkboard":"corkboard","dark_mosaic":"dark mosaic","moulin":"moulin","padded":"padded","simple_dashed":"simple dashed","squares":"squares","dark_wood":"wood, dark","wood_1":"wood, dark grey","purty_wood":"wood, purty","retina_wood":"wood, retina"}}
				...
				,{"name":"TicketThumbnailSize","label":"Thumbnail max size","type":"text","html5":"range",ops:{"min":50,"max":200,"step":5,"range-type":"px"}}
				,{"name":"TicketThumbnailType","label":"Thumbnail file type","type":"text"}
				,{"name":"TicketThumbnailRegExp","label":"Thumbnail RegExp","type":"text"}
			]
		},
		init:function(){
