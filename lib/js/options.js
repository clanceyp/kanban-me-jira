    ...
    options = {
        ops:{
            "input":[
                ...
                {"name":"JiraAPI","label":"JIRA filter xml","type":"text", className:"allowDblClickReset"},
                {"name":"keyNavigation","label":"Arrow key navigation","type":"checkbox", className:"allowDblClickReset"},
                {"name":"RefreshTime","label":"Refresh time","type":"text", className:"allowDblClickReset","html5":"range",  parent:'advanced',ops:{"min":5,"max":600,"step":5,"range-type":"s"}},
                ...
                {"name":"PopupTemplate","label":"Mustache template","type":"textarea",  parent:'advanced', className:"allowDblClickReset"},
                ...
                {"name":"TicketThumbnailForceSize","label":"Thumbnail fix size","type":"checkbox"},
        ...
        handleDblClick:function(e){
            var target = e.target,
                id = $(target).attr('id');
            if (!target){return true;}
            if (DEFAULT_VALUES[id] && window.confirm('Reset this element to it\'s default value')){
