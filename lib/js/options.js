    ...
    options = {
        ops:{
            "input":[
                ...
                {"name":"AvatarUseJIRAProfile","label":"Use JIRA Profile avatar","type":"checkbox", parent:'advanced'},
                {"name":"JIRAProfileJSONurl","label":"JIRA Profile URL (JSON)","type":"text", parent:'advanced'},
                {"name":"AvatarJIRADefault","label":"Avatar JIRA default (unassigned)","type":"text", parent:'advanced'},
