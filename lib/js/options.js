    ...
    options = {
        ops:{
            "input":[
                ...
                ,{"name":"TicketWidth","label":"Ticket width","type":"text",  parent:'advanced', "html5":"range",ops:{"min":160,"max":400,"step":10,"range-type":"px"}}
                ,{"name":"TicketHeight","label":"Ticket height","type":"text",  parent:'advanced', "html5":"range",ops:{"min":80,"max":300,"step":10,"range-type":"px"}}
        ...
        setupForm:function(){
            for (var i = 0; i<options.ops.input.length; i++){
                ...
                if (item.type === "button"){
                        $(parent)
                            .append('<p class="'+ className +'"><label for="'+item.name+'">'+ item.label +'</label><input class="'+ item.className+'" '+ opsStr +' type="'+ type +'" id="'+ item.name +'" value="'+ value +'" /></p>');
                    ...
                    $('#'+ item.name).val( value );// set the value
                } else if (item.type === "textarea"){
                    $(parent)
                        .append('<p class="'+ className +'"><label for="'+item.name+'">'+ item.label +'</label><textarea '+ opsStr +' id="'+ item.name +'">'+value+'</textarea></p>');
                }
            }
