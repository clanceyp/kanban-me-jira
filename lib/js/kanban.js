(function($, _, can, chrome, d3, less, window){
    ...
    var backgroundPage = chrome.extension.getBackgroundPage(),
        kanban = {
            ...
            JIRAProfileJSONurl: backgroundPage.kmj.getLocalStore("JIRAProfileJSONurl", 0, 0),
            ...
            postRender:function(){
                ...
                $("article.ticket img").each(function(i, el){
                    ...
                    if (kanban.avatarUseJIRAProfile){
                        ...
                        if (ticketThumbnailBase.indexOf('$thum.type') > -1) {
                            ticketThumbnailBase = ticketThumbnailBase.replace("$thum.type", backgroundPage.kmj.getLocalStore("TicketThumbnailType"));
                        }
