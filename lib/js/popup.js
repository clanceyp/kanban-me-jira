(function($, can, chrome){
        ...
        popup = {
            ...
            render:function(){
                ...
                if (popup.items.length) {
                    ...
                    if (backgroundPage.kmj.items.length === 0 && backgroundPage.kmj.connected === true){
                        html = popup.messages.noIssues;
                    } else if (!backgroundPage.kmj.getLocalStore("PopupFilterID")){
    ...
    $(document).ready(function(){
        ...
        $("#refresh").on('click',function(){
            ...
            checking = window.setTimout(function(){popup.monitor();}, 3000);
        });
