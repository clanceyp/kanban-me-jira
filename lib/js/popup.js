	...
	var backgroundPage = chrome.extension.getBackgroundPage(),
        popup = {
            ...
            monitor:function(){
                ...
                if (popup.forceReload || backgroundPage.kmj.items.length !== popup.items.length){/* don't refresh unless something has been added or removed */
