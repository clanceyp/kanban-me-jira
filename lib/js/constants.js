...
const HELP = {
	...
	,"TicketThumbnailForceSize": 'Override natural image size and fix to the value set by maxsize (images will be square)'
	,"TicketThumbnailBase":'URL where the assignee images are located'
