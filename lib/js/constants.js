...
const HELP = {
	...
	,"TicketKeepInViewport":"Keep tickets in viewport, allow tickets to pile ontop of eachother instead of dropping delow the fold" 
	,"TicketThumbnailBase":'Fully qualifide URL where the assignee images are located, e.g. http://my.domain.com/jira/secure/useravatar?size=large&ownerId='
