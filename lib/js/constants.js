...
const HELP = {
	...
	,"TicketThumbnailBase":'URL when the assignee images can be found'
	,"TicketThumbnailType":'File extension for assignee images, e.g. .gif, .png etc...'
	...
	,"BackgroundImage":'Background image used on the kanban page'
	,"Background":''
}
